...
!----------------------------------------------------------------------!
  ...
  write(*,*)' Enter name of case which solution you interpolate on new mesh (without ext.) : '
  read(*,*) name 
  write(*,*)' Enter name of present case (without ext.): '
  read(*,*) namSav 
  write(*,*)' Enter number of subdomains: '
  read(*,*) ND 
  write(*,*)' Enter 1 if temperature field is to be interpolated and 0 if not : '
  read(*,*) IND
