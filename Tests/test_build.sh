...
# generator tests
#------------------------------------------------------------------------------#
ln -rsf $GEN $TEST_DIR/Laminar/Backstep_Orthogonal/Generate
ln -rsf $GEN $TEST_DIR/Laminar/Backstep_Nonorthogonal/Generate
ln -rsf $GEN $TEST_DIR/Rans/Backstep_Re_26000_Rsm/Generate
ln -rsf $GEN $TEST_DIR/Rans/Backstep_Re_28000/Generate
ln -rsf $GEN $TEST_DIR/Rans/Channel_Re_Tau_590_Wall_Function/Generate
