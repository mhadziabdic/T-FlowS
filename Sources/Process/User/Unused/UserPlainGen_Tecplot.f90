!======================================================================!
  subroutine UserPlainGen_Tecplot(grid, n)
!----------------------------------------------------------------------!
!----------------------------------------------------------------------!
!----------------------------------------------------------------------!
  use all_mod
...
!   Pk_tmp = Pk_tmp/(a_mn_a_mn*Shear(c))
           ...
           write (500+this,'(7E17.7E3)') xc(c), yc(c), U % n(c), V % n(c), W % n(c), Kin % n(c), VISt(c)
...
!    TKE = 0.5*(uu%mean(c)+vv%mean(c)+ww%mean(c)) + &
!    0.5*(VAR10x(c)-U%mean(c)*U%mean(c)+VAR10y(c)-V%mean(c)*V%mean(c)+VAR10z(c)-W%mean(c)*W%mean(c))
    TKE = 0.5*(VAR10x(c)-U%mean(c)*U%mean(c)+VAR10y(c)-V%mean(c)*V%mean(c)+VAR10z(c)-W%mean(c)*W%mean(c))
...
!              u13*Wx(c) + u23*Wy(c) + u33*Wz(c))
   ...
   TKE_mean = 0.5*max(uu%mean(c)+vv%mean(c)+ww%mean(c),1.0e-12)
   ...
   if(Kin % n(c)<5.0e-6) Cmu_mod = 0.0
   Cmu_mod = min(0.09,Cmu_mod)
   

!   write (500+this,'(9E17.7E3)') xc(c),yc(c),U % n(c),V % n(c), Cmu_mod, Pk_tmp, a_mn_a_mn, Cs_mod, Cs_prime 
           write (500+this,'(16E17.7E3)') xc(c), yc(c), U % n(c), V % n(c), W%n(c), P % n(c), Kin%n(c),&
...
!    end if
  ...
  end subroutine UserPlainGen_Tecplot
