...
!---------------------------------[Arguments]----------------------------------!
  type(Grid_Type) :: grid
!-----------------------------------[Locals]-----------------------------------!
  integer              :: c, s, c1, c2, sub
  integer              :: n_cells_sub, n_faces_sub, n_bnd_cells_sub, NCSsub
...
!==============================================================================!
  ...
  do sub = 1, n_sub
    ...
    write(9, '(2i9)') n_cells_sub, n_bnd_cells_sub
    ...
    ! ... and then followed by the cells on the boundary
